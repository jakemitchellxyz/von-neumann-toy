...
bool initialize(const std::string& kernelDir) {
    ...
    std::cout << "SPICE: Loading kernels from " << kernelDir << std::endl;
    ...
    for (const auto& entry : fs::directory_iterator(kernelDir)) {
        ...
        if (shouldLoad) {
            ...
            if (checkSpiceError("furnsh_c")) {
                std::cerr << "SPICE: Failed to load kernel: " << pathStr << std::endl;
                continue;
            }

            std::cout << "SPICE: Loaded " << entry.path().filename().string() << std::endl;
            kernelsLoaded++;
    ...
    if (!hasLsk) {
        std::cerr << "SPICE: Warning - No LSK (leap seconds) kernel found." << std::endl;
    }
...
double utcToTdbJulian(int year, int month, int day, int hour, int minute, double second) {
    ...
    // Build UTC string
    char utcStr[64];
    snprintf(utcStr, sizeof(utcStr), "%04d-%02d-%02dT%02d:%02d:%06.3f",
...
bool getBodyState(int naifId, double jdTdb, glm::dvec3& position, glm::dvec3& velocity) {
    ...
    spkezr_c(
        std::to_string(naifId).c_str(),  // Target body
        et,                               // Epoch (TDB)
...
glm::dvec3 getBodyPoleDirection(int naifId, double jdTdb) {
    ...
    switch (naifId) {
        case 10:  iauFrame = "IAU_SUN"; break;
        case 1: case 199:  iauFrame = "IAU_MERCURY"; break;
        case 2: case 299:  iauFrame = "IAU_VENUS"; break;
        case 3: case 399:  iauFrame = "IAU_EARTH"; break;
        case 301: iauFrame = "IAU_MOON"; break;
        case 4: case 499:  iauFrame = "IAU_MARS"; break;
        case 5: case 599:  iauFrame = "IAU_JUPITER"; break;
        case 501: iauFrame = "IAU_IO"; break;
        case 502: iauFrame = "IAU_EUROPA"; break;
        case 503: iauFrame = "IAU_GANYMEDE"; break;
        case 504: iauFrame = "IAU_CALLISTO"; break;
        case 6: case 699:  iauFrame = "IAU_SATURN"; break;
        case 606: iauFrame = "IAU_TITAN"; break;
        case 7: case 799:  iauFrame = "IAU_URANUS"; break;
        case 8: case 899:  iauFrame = "IAU_NEPTUNE"; break;
        case 801: iauFrame = "IAU_TRITON"; break;
        case 9: case 999:  iauFrame = "IAU_PLUTO"; break;
        case 901: iauFrame = "IAU_CHARON"; break;
        default: return glm::dvec3(0.0, 1.0, 0.0);
    }
    ...
    glm::dvec3 poleJ2000(
        tipm[0][2],  // Z column of rotation matrix
        tipm[1][2],
        tipm[2][2]
    );
...
static const char* getIAUFrameName(int naifId) {
    switch (naifId) {
        case 10:  return "IAU_SUN";
        case 1: case 199:  return "IAU_MERCURY";
        case 2: case 299:  return "IAU_VENUS";
        case 3: case 399:  return "IAU_EARTH";
        case 301: return "IAU_MOON";
        case 4: case 499:  return "IAU_MARS";
        case 5: case 599:  return "IAU_JUPITER";
        case 501: return "IAU_IO";
        case 502: return "IAU_EUROPA";
        case 503: return "IAU_GANYMEDE";
        case 504: return "IAU_CALLISTO";
        case 6: case 699:  return "IAU_SATURN";
        case 606: return "IAU_TITAN";
        case 7: case 799:  return "IAU_URANUS";
        case 8: case 899:  return "IAU_NEPTUNE";
        case 801: return "IAU_TRITON";
        case 9: case 999:  return "IAU_PLUTO";
        case 901: return "IAU_CHARON";
...
glm::dvec3 getBodyPrimeMeridian(int naifId, double jdTdb) {
    ...
    glm::dvec3 pmJ2000(
        tipm[0][0],  // X column of rotation matrix
        tipm[1][0],
        tipm[2][0]
    );
...
bool hasRotationData(int naifId) {
    ...
    switch (naifId) {
        case 10:  bodyName = "SUN"; break;
        case 1: case 199:  bodyName = "MERCURY"; break;
        case 2: case 299:  bodyName = "VENUS"; break;
        case 3: case 399:  bodyName = "EARTH"; break;
        case 301: bodyName = "MOON"; break;
        case 4: case 499:  bodyName = "MARS"; break;
        case 5: case 599:  bodyName = "JUPITER"; break;
        case 501: bodyName = "IO"; break;
        case 502: bodyName = "EUROPA"; break;
        case 503: bodyName = "GANYMEDE"; break;
        case 504: bodyName = "CALLISTO"; break;
        case 6: case 699:  bodyName = "SATURN"; break;
        case 606: bodyName = "TITAN"; break;
        case 7: case 799:  bodyName = "URANUS"; break;
        case 8: case 899:  bodyName = "NEPTUNE"; break;
        case 801: bodyName = "TRITON"; break;
        case 9: case 999:  bodyName = "PLUTO"; break;
        case 901: bodyName = "CHARON"; break;
...
static const char* getBodyNameForId(int naifId) {
    switch (naifId) {
        case NAIF_SUN:      return "SUN";
        case 1: case 199:   return "MERCURY";
        case 2: case 299:   return "VENUS";
        case 3: case 399:   return "EARTH";
        case NAIF_MOON:     return "MOON";
        case 4: case 499:   return "MARS";
        case 5: case 599:   return "JUPITER";
        case 501:           return "IO";
        case 502:           return "EUROPA";
        case 503:           return "GANYMEDE";
        case 504:           return "CALLISTO";
        case 6: case 699:   return "SATURN";
        case 606:           return "TITAN";
        case 7: case 799:   return "URANUS";
        case 8: case 899:   return "NEPTUNE";
        case 801:           return "TRITON";
        case 9: case 999:   return "PLUTO";
...
glm::dvec3 getBodyRadii(int naifId) {
    if (!g_initialized) return glm::dvec3(0.0);
    
    const char* bodyName = getBodyNameForId(naifId);
    if (!bodyName) return glm::dvec3(0.0);
...
double getLatestAvailableTime() { return g_validEndJD; }
double getEarliestAvailableTime() { return g_validStartJD; }
...
bool hasBodyData(int naifId) { return false; }

glm::dvec3 getBodyPoleDirection(int naifId, double jdTdb) {
    return glm::dvec3(0.0, 1.0, 0.0);  // Default: ecliptic north
}

bool hasRotationData(int naifId) { return false; }

glm::dvec3 getBodyRadii(int naifId) { return glm::dvec3(0.0); }
double getBodyMeanRadius(int naifId) { return 0.0; }
double getBodyGM(int naifId) { return 0.0; }
double getBodyMass(int naifId) { return 0.0; }
